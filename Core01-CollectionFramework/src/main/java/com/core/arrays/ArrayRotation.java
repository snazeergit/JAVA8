 ...
 * 
 * source_arr : array to be copied from sourcePos : starting position in source
 * array from where to copy dest_arr : array to be copied in destPos : starting
 * position in destination array, where to copy in len : total no. of components
 * to be copied.
 */
